...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 *
	 * context: {"env":"production","urlBasePath":"","sourceMaps":false,"kbnVersion":"4.5.3","buildNum":9910}
	 * includes code from:
	 *  - elasticsearch@1.0.0
	...
	__webpack_require__(1066).bootstrap();
	/* xoxo */
...
/***/ function(module, exports, __webpack_require__) {
	...
	var notify = __webpack_require__(1118);

	__webpack_require__(1810);
	__webpack_require__(1815);

	var chrome = __webpack_require__(1066).setTabs([{
	  id: '',
	  title: 'Server Status',
	  activeIndicatorColor: '#EFF0F2'
	}]).setRootTemplate(__webpack_require__(1816)).setRootController('ui', function ($http, $scope) {
	  var ui = this;
	  ui.loading = false;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var numeral = __webpack_require__(944);

	var toTitleCase = __webpack_require__(1811);
	var formatNumber = __webpack_require__(1812);
	var readStatData = __webpack_require__(1813);
	...
	__webpack_require__(1074).get('kibana', []).directive('statusPageMetric', function () {
	  return {
	    restrict: 'E',
